...
$svcAlias = isdefined($viewData->svcInfo, 'alias');
...
?>
        <th colspan="2">Delete Service Template Information for <?php echo $svcName?> from <?php echo $deployment?></th>
<?php
} else {
?>
        <th colspan="2">View Service Template Information for <?php echo $svcName?> in <?php echo $deployment?></th>
<?php
}
?>
    </thead>
...
if ($viewData->delFlag === true) {
?>
<a href="action.php?controller=svctemp&action=<?php echo $action?>&deployment=<?php echo $deployment?>&svctemp=<?php echo $svcName?>" class="deployBtn">Delete</a>
<a href="action.php?controller=svctemp&action=stage&deployment=<?php echo $deployment?>" class="deployBtn">Cancel</a>
<?php
} else {
?>
<a href="action.php?controller=svctemp&action=stage&deployment=<?php echo $deployment?>" class="deployBtn">Service Templates</a>
<?php
}
?>
</div>
