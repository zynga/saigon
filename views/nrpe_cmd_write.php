...
?>
Successfully wrote NRPE Command Information for <?php echo $viewData->command?> in Deployment <?php echo $viewData->todeployment?> to datastore...
<?php
} else {
?>
Successfully wrote NRPE Command Information for <?php echo $viewData->command?> in Deployment <?php echo $viewData->deployment?> to datastore...
<?php
}
?>
