...
$svcAlias = isset($viewData->svcInfo['alias'])?$viewData->svcInfo['alias']:'';
...
<div id="svc-template" style="border-width:2px;width:97%;left:5;top:45;position:absolute" class="admin_box_blue divCacGroup admin_border_black">
<?php
} else {
?>
<div id="svc-template" style="border-width:2px;width:97%;left:5;top:5;position:absolute" class="admin_box_blue divCacGroup admin_border_black">
<?php
}
?>
<form method="post" action="action.php?controller=svctemp" name="svc_template_submit_form">
...
if ($action == 'add_write') {
?>
        <th colspan="4">Add Service Template to <?php echo $deployment?></th>
<?php
} else if ($action == 'modify_write') {
?>
        <th colspan="4">Modify Service Template Information for <?php echo $svcName?> in <?php echo $deployment?></th>
<?php
} else if ($action == 'copy_write') {
?>
        <th colspan="4">Copy Service Template Information for <?php echo $svcName?> to <?php echo $deployment?></th>
<?php
}
?>
    </thead>
    <tr>
        <th style="width:30%;text-align:right;">Name:<br /><font size="2">Ex: generic-service</font></th>
        ...
        <th style="width:30%;text-align:right;">Alias:<br /><font size="2">Ex: default service alert and check setup</font></th>
        <td style="text-align:left;" colspan="3"><input type="text" value="<?php echo $svcAlias?>" size="64" maxlength="128" id="svcAlias" name="svcAlias" /></td>
    </tr><tr>
...
?>
        ...
        <td colspan="3"><div class="divCacGroup" style="width:98%;min-height:20px;text-align:left;">
        ...
        <td colspan="4">
            <div class="parentClass divCacGroup" id="svctmpstateinfo" style="text-align:left;text-indent:25px;background-color:#91C5D4;border-radius:4px;">
                <img src="static/imgs/plusSign.gif">
                State Related Information:
            </div>
            <div class="divHide parent-desc-svctmpstateinfo">
...
?>
                        ...
                        <td style="text-align:left;">
                            <select id="ppdata" name="ppdata" multiple="multiple">
                                <option value=""> - Null or incl from Template - </option>
<?php
if (($svcPPData == 0) && (!empty($svcPPData))) {
?>
...
?>
                        ...
                        <td style="text-align:left;">
                            <select id="retstatusinfo" name="retstatusinfo" multiple="multiple">
                                <option value=""> - Null or incl from Template - </option>
<?php
if (($svcRetStatusInfo == 0) && (!empty($svcRetStatusInfo))) {
?>
                                <option value="on">On</option>
                                <option value="off" selected>Off</option>
<?php
...
?>
                        ...
                        <td style="text-align:left;">
                            <select id="retnstatusinfo" name="retnstatusinfo" multiple="multiple">
                                <option value=""> - Null or incl from Template - </option>
<?php
if (($svcRetNStatusInfo == 0) && (!empty($svcRetNStatusInfo))) {
?>
                                <option value="on">On</option>
                                <option value="off" selected>Off</option>
<?php
...
?>
        ...
        <td colspan="4">
            <div class="parentClass divCacGroup" id="svctmpchkinfo" style="text-align:left;text-indent:25px;background-color:#91C5D4;border-radius:4px;">
                <img src="static/imgs/plusSign.gif">
                Check Related Information:
            </div>
            <div class="divHide parent-desc-svctmpchkinfo">
                <table style="width:99%;">
                    <tr>
...
?>
                        ...
                        <th style="width:30%;text-align:right;">Max Check Attempts:<br /><font size="2">(# of checks before sending alert)</font></th>
                        <td style="text-align:left;">
...
?>
                        ...
                        <th style="width:30%;text-align:right;">Check Interval:<br /><font size="2">(time between normal checks)</font></th>
                        <td style="text-align:left;">
...
?>
                        ...
                        <th style="width:30%;text-align:right;">Check Retry Interval:<br /><font size="2">(time between error checks)</font></th>
                        <td style="text-align:left;">
...
?>
                        ...
                        <td style="text-align:left;">
                            <select id="activechk" name="activechk" multiple="multiple">
                                <option value=""> - Null or incl from Template - </option>
<?php
if (($svcActChks == 0) && (!empty($svcActChks))) {
?>
                                <option value="on">On</option>
                                <option value="off" selected>Off</option>
<?php
...
?>
                        ...
                        <td style="text-align:left;">
                            <select id="passivechk" name="passivechk" multiple="multiple">
                                <option value=""> - Null or incl from Template - </option>
<?php
if (($svcPsvChks == 0) && (!empty($svcPsvChks))) {
?>
                                <option value="on">On</option>
                                <option value="off" selected>Off</option>
<?php
...
?>
        ...
        <td colspan="4">
            <div class="parentClass divCacGroup" id="svctmpcontactinfo" style="text-align:left;text-indent:25px;background-color:#91C5D4;border-radius:4px;">
                <img src="static/imgs/plusSign.gif">
                Contact Related Information:
            </div>
            <div class="divHide parent-desc-svctmpcontactinfo">
                <table style="width:99%;">
                    <tr>
...
?>
        ...
        <td colspan="4">
            <div class="parentClass divCacGroup" id="svctmpnotifinfo" style="text-align:left;text-indent:25px;background-color:#91C5D4;border-radius:4px;">
                <img src="static/imgs/plusSign.gif">
                Notification Related Information:
            </div>
            <div class="divHide parent-desc-svctmpnotifinfo">
                <table style="width:99%;">
                    <tr>
                        ...
                        <td style="text-align:left;">
                            <select id="notifenabled" name="notifenabled" multiple="multiple">
                                <option value=""> - Null or incl from Template - </option>
<?php
if (($svcNotifEn == 0) && (!empty($svcNotifEn))) {
?>
                                <option value="on">On</option>
                                <option value="off" selected>Off</option>
<?php
...
?>
                        ...
                        <th style="width:30%;text-align:right;">Notification Interval:<br /><font size="2">(time between sending alerts)</font></th>
                        <td style="text-align:left;">
...
?>
        ...
        <td colspan="4">
            <div class="parentClass divCacGroup" id="svctmpfreshinfo" style="text-align:left;text-indent:25px;background-color:#91C5D4;border-radius:4px;">
                <img src="static/imgs/plusSign.gif">
                Freshness Related Information:
            </div>
            <div class="divHide parent-desc-svctmpfreshinfo">
                <table style="width:99%;">
                    <tr>
