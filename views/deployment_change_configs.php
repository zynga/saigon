...
<div id="encapsulate" style="position:absolute;top:5;left:5;width:98%;">
    <div class="divCacGroup admin_box admin_box_blue admin_border_black">
        ...
        <b>Current Active Revision:</b> <?php echo $viewData->revs['currrev']?>
        <div class="divCacGroup"></div>
        <div class="divCacResponse">
            Please choose the Revision you would like to make active...<br />
            <form method="post" action="action.php" name="deployment_config_change_write">
                <input type="hidden" id="controller" name="controller" value="deployment" />
                <input type="hidden" id="action" name="action" value="chg_configs_write" />
                <input type="hidden" id="deployment" name="deployment" value="<?php echo $viewData->deployment?>" />
                <input type="hidden" id="currrev" name="currrev" value="<?php echo $viewData->revs['currrev']?>" />
                Update Note: <input type="text" id="note" name="note" size="64" maxlength="512" /><br />
