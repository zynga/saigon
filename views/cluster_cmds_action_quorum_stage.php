...
$cmdQuorum = isset($viewData->clustercmdsInfo['quorum'])?$viewData->clustercmdsInfo['quorum']:'';
...
if ($action == 'add_write') {
?>
            <th colspan="4">Add Cluster Quorum Command to <?php echo $deployment?></th>
<?php
} else if ($action == 'modify_write') {
?>
            <th colspan="4">Modify Cluster Quorum Command <?php echo $cmdName?> in <?php echo $deployment?></th>
<?php
} else if ($action == 'copy_write') {
?>
            <th colspan="4">Copy Cluster Quorum Command <?php echo $cmdName?> to <?php echo $deployment?></th>
<?php
}
?>
        </thead>
        <tr>
            ...
            <th style="width:30%;text-align:right;">Nagios Server:<br /><font size="2">Ex: cloudeng-infra-nagios-ch-001 or 10.181.62.80</font></th>
            <td colspan="3" style="text-align:left;">
...
?>
            ...
            <th style="width:30%;text-align:right;">Quorum Value:<br /><font size="2"># of Expected Responses for Quorum Completeness</font></th>
            <td style="text-align:left;">
                <input type="text" value="<?php echo $cmdQuorum?>" size="7" maxlength="6" id="cmdquorum" name="cmdquorum" />
            </td>
        </tr>
