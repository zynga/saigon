...
<h2>Available Supplemental NRPE Plugins</h2>
...
?>
                <a class="deployBtn" title="View" href="action.php?controller=nrpeplugin&action=show_sup_plugin_common&deployment=<?php echo $deployment?>&plugin=<?php echo $nrpeplugin?>">View</a>
                <a class="deployBtn" title="Copy" href="action.php?controller=nrpeplugin&action=copy_common_stage_sup&deployment=<?php echo $deployment?>&plugin=<?php echo $nrpeplugin?>">Copy</a>
<?php
            } else {
?>
...
<a href="action.php?controller=nrpeplugin&action=add_sup_stage&deployment=<?php echo $deployment?>" class="menuItem">Add Supplemental NRPE Plugin</a>
</div>
<div>
